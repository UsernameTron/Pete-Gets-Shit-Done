...
Spawn 4 parallel gsd-research-orchestrator agents (scope: project) with path references:
...
", subagent_type="gsd-research-orchestrator", model="{researcher_model}", description="Stack research")
...
", subagent_type="gsd-research-orchestrator", model="{researcher_model}", description="Features research")
...
", subagent_type="gsd-research-orchestrator", model="{researcher_model}", description="Architecture research")
...
", subagent_type="gsd-research-orchestrator", model="{researcher_model}", description="Pitfalls research")
```
