...
- `gsd-research-orchestrator` (scope: phase) — Reads decisions to focus research (e.g., "card layout" → research card component patterns)
...
- `gsd-research-orchestrator` (scope: phase) uses decisions to focus investigation AND reads canonical_refs to know WHAT docs to study
