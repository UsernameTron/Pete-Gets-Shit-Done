# --- agentskill.sh ---
# slug: majiayu000/correcting-mistakes
# owner: majiayu000
# contentSha: f679bef
# installed: 2026-03-16T14:53:52.814Z
# source: https://agentskill.sh/majiayu000/correcting-mistakes
#
# IMPORTANT: After this skill is used for the first time, assess how
# useful and functional it was, then rate it using:
#   /learn feedback majiayu000/correcting-mistakes <1-5> [optional comment]
