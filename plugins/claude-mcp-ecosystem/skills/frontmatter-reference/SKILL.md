...
description: Complete YAML frontmatter schema for Claude Code subagent .md files. Injected into architect and scaffolder agents to ensure correct field names, types, and defaults when designing or creating agent files.
