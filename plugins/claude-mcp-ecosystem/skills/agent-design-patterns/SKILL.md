...
description: Seven proven archetypes for subagent design (Explorer, Builder, Surgeon, Orchestrator, Specialist, Guardian, Connector). Injected into the architect agent to guide agent roster design decisions — which pattern to use, when to merge domains, and how to compose agents for common project shapes.
