...
- `gsd-research-orchestrator` -- unified research (scope: phase/project)
...
| 1 → 2 | No-op version bump (previously injected `routing_strategy`/`adaptive` defaults; both keys retired with the intelligence layer) |
