...
**GSD wraps software delivery in a governed 5-phase lifecycle — 235 components, 11 clusters, one map.**
...
flowchart LR
  C0(["C0 Session & Context Lifecycle (28)"])
  C1["C1 Discuss & Define (20)"] --> C2["C2 Plan & Architect (15)"] --> C3["C3 Execute & Build (29)"] --> C4["C4 Verify & Review (20)"] --> C5["C5 Ship & Release (8)"]
  C0 --> C1
  C5 --> C0
  C8["C8 Backlog & Task Management (8)"] --> C1
  C6["C6 Milestone & Workstream Orchestration (17)"] --> C2
  C7["C7 Governance, Health & Audit (27)"] -.-> C3
  C7 -.-> C5
...
| Cluster | Components |
|---|---|
| C1 — Discuss & Define | 20 |
| C2 — Plan & Architect | 15 |
| C3 — Execute & Build | 29 |
| C4 — Verify & Review | 20 |
| C5 — Ship & Release | 8 |
| C0 — Session & Context Lifecycle | 28 |
| C6 — Milestone & Workstream Orchestration | 17 |
| C7 — Governance, Health & Audit | 27 |
| C8 — Backlog & Task Management | 8 |
| C9 — Agent Lifecycle & Team Ops | 19 |
| C10 — Extension & Agent Engineering | 42 |
| C-UNMAPPED — Unmapped | 2 |

Counts equal the full map's 235-row Master matrix; 8 archived components stay in their functional clusters. Full detail: `.planning/GSD-ECOSYSTEM-MAP.md`
